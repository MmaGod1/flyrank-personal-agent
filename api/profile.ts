...
import { DEFAULT_PROFILE, type UserProfile } from "../src/types.js";
...
function isValidProfilePayload(value: unknown): value is Partial<UserProfile> {
  ...
  if (request.method === "POST") {
    try {
      ...
      const updated: UserProfile = {
        ...
        experienceLevel:
          typeof body.experienceLevel === "string" ? body.experienceLevel : existing.experienceLevel,
        preferredLocation:
          typeof body.preferredLocation === "string" ? body.preferredLocation : existing.preferredLocation,
        workArrangement:
        ...
        otherPreferences:
          typeof body.otherPreferences === "string" ? body.otherPreferences : existing.otherPreferences,
